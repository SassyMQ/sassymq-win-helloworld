...
namespace SassyMQ.Lib.RabbitMQ.Payload
{
        ...
        where T : StandardPayload<T>, new()
    {
        ...
        public void AttemptConnect()
        {
            ...
            this.RMQFactory = new ConnectionFactory() { HostName = this.RabbitEndpoint, VirtualHost = this.VirtualHost, UserName = this.Username, Password = this.Password, Ssl = new SslOption(this.RabbitEndpoint, enabled: true) };
